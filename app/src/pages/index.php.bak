...
<div class="left ui-widget-content white-border">
    <div class="top">
        <div class="panel" id="panel">
            <p>Hello,<span id="nicname"><?=(isset($_COOKIE['nicname']))? $_COOKIE['nicname'] : ''?></span>&nbsp;<a class="exit-icon" href="/logout" id="exit-btn"></a> <!--<span style="cursor:pointer" id="test">test</span>-->
            </p>
